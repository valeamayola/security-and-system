export default function OurWork() {
    return (
        <div className="flex bg-gradient-to-b from-slate-950 via-blue-950 to-blue-950 flex-col items-center justify-between py-10 px-32">
            <h1 className="text-blue-400 border-2 border-white rounded-full px-8 py-4 uppercase text-xl font-bold">Nuestros trabajos</h1>
            <p className="text-white text-2xl font-medium mt-5">Explora nuestros trabajos y descubre cómo hemos ayudado a nuestros clientes a alcanzar sus objetivos en línea.</p>
            <div className="flex flex-row items-center">
                <img className="w-full h-[20rem]" src="/berlin-mockup.png"></img>
                <img className="w-full h-[30rem]" src="/pc-mockup.png"></img>
                <img className="w-full h-[20rem]" src="/sdp-mockup.png"></img>
            </div>
