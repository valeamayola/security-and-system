...
export default function AboutUs() {
    return (
        <div className="flex bg-gradient-to-b from-slate-950 via-blue-950 to-blue-950 flex-row items-center justify-between py-20 px-32">
            <div className="flex flex-col items-start w-[200rem] mx-5">
            ...
            <div className="card mx-5 bg-transparent border-2 border-blue-800/50 shadow-blue-800/50 shadow-2xl">
