            ...
            <div className="w-full bg-gradient-to-b from-blue-950 via-slate-950 to-slate-950 flex flex-col md:flex-row md:px-32 py-20 items-center align-items justify-center">
                <div className="flex flex-col">
                    ...
                    <div className='flex flex-col md:flex-row items-start'>
                        ...
                        <a className="btn w-60 md:w-60 text-xl md:text-lg mt-5 md:mt-10 mx-5 font-medium rounded-full border-sky-50 border-4 bg-transparent text-sky-50 hover:bg-gray-900" href="/servicios">Ver servicios</a>
                    </div>
                </div>
