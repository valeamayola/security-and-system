            ...
            <div className="flex flex-col md:flex-row md:px-32 py-20 items-center align-items justify-center">
                <div className="flex flex-col">
                    ...
                    <div className='flex flex-col md:flex-row items-start'>
                        <a className="btn w-60 md:w-60 text-xl md:text-lg mt-10 mx-5 font-medium rounded-full border-blue-900 border-4 bg-blue-900 text-white hover:bg-gray-900" href="https://api.whatsapp.com/send/?phone=%2B541156260023&text&type=phone_number&app_absent=0" target="_blank">Contratar servicio</a>
                        <a className="btn w-60 md:w-60 text-xl md:text-lg mt-5 md:mt-10 mx-5 font-medium rounded-full border-sky-50 border-4 bg-transparent text-sky-50 hover:bg-gray-900" href="https://api.whatsapp.com/send/?phone=%2B541156260023&text&type=phone_number&app_absent=0" target="_blank">Conocer más</a>
                    </div>
                </div>
