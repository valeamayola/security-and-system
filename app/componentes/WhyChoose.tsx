...
export default function WhyChoose() {
    return (
        <div className="bg-slate-950 flex flex-col items-center justify-between px-44">
            <div className="flex flex-row justify-around">
                <div className="card w-full bg-transparent border-2 border-blue-800/50 shadow-blue-800/50 shadow-2xl m-5">
